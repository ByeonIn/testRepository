	...
	<div class="outer">
		...
		<form action="<%=contextPath%>/insert.ph" method="post" id="enroll-form" enctype="multipart/form-data">
			...
			<table align="center">
				...
				<tr>
					<th>내용</th>
					<td colspan="3"><textarea rows="10" cols="30" name="content" style="resize:none;"></textarea></td>
				</tr>
				<tr>
					<th>대표이미지</th>
			...
			<div id="file-area" align="center">
				<input type="file" id="file1" name="file1" onchange="loadImg(this,1);" required><!-- 대표이미지라서 필수입력사항 --><br>
